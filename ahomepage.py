...
if uploaded_file is not None and result:
    ...
    esp3 = pd.read_csv("esppetang_jn.csv")
...
if result:
    ...
    options = st.sidebar.radio('Select what you want to display:', ['Home', 'Second'])
